...
Write-Host "$(Get-Date -format 'u') - Installing & Setting up SpotApi Service"
...
Write-Host "$(Get-Date -format 'u') - Enabling and Starting up SpotApi Service"
Set-Service -Name SpotApi -StartupType Automatic
Start-Service -Name SpotApi
